...
<footer>
    <div class="footer-inner">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-lg-4 col-md-offset-4">
        ...
        <div class="container">
            <div class="col-sm-12 col-xs-12 footer-logo"><img alt="Datson" src="{{asset('user/home/images/logo.png')}}"></div>
            <address>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-xs-12 coppyright">Copyright © 2019 </div>
...
<!-- JavaScript -->
<script type="text/javascript" src="{{asset('user/home/js/jquery.min.js')}}"></script>
<script type="text/javascript" src="{{asset('user/home/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('user/home/js/common.js')}}"></script>
<script type="text/javascript" src="{{asset('user/home/js/countdown.js')}}"></script>
<script type="text/javascript" src="{{asset('user/home/js/owl.carousel.min.js')}}"></script>
